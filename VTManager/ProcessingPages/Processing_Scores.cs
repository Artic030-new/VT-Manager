...
namespace WpfApp1
{
    public partial class Processing_Search : System.Windows.Controls.Page
    {
        ...
        private void search_button_Click(object sender, RoutedEventArgs e)
        {
            ...
            string filters = (!(personal_field.Text == "сотрудник...")) ?
                search += " AND firstName LIKE " + "\'" + StringUtils.replaceAllUnsupportedChr(personal_field.Text.Trim(StringUtils.trimmer)) + "%\'"
